...
def solutions(request):
    return render(
        ...
        "web/solutions.html",
        {
            "page": page_meta(
                request,
                title="Решения по формату объекта: отель, мини-отель, апартаменты, сеть | ТЕХБИЗ",
                description="Автоматизация под формат объекта: городской и курортный отель, мини-отель и гостевой дом, апартаменты и УК, сеть отелей. Подбираем стек и сценарии под реальный операционный процесс.",
            ),
            "solutions": Solution.objects.published(),
            "form": lead_form(request),
        },
